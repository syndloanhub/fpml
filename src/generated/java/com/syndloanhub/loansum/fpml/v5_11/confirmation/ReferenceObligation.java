    ...
    implements Serializable
{
    ...
    protected List<Serializable> guarantorOrGuarantorReference;
     ...
     * 
     */
    public List<Serializable> getGuarantorOrGuarantorReference() {
        if (guarantorOrGuarantorReference == null) {
            guarantorOrGuarantorReference = new ArrayList<Serializable>();
        }
