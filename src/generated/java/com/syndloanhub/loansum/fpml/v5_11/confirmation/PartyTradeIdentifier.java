 ...
 *         &lt;element name="linkedTrade" type="{http://www.fpml.org/FpML-5/confirmation}LinkedTrade" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    implements Serializable
{
    ...
    protected List<LinkedTrade> linkedTrade;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the linkedTrade property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getLinkedTrade().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<LinkedTrade> getLinkedTrade() {
        if (linkedTrade == null) {
            linkedTrade = new ArrayList<LinkedTrade>();
        }
